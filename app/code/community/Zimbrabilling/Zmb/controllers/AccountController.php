...
class Zimbrabilling_Zmb_AccountController extends Mage_Customer_AccountController
{
  ...
  public function loginPostAction()
   ...
   public function _loginPostRedirect()
    ...
    public function createPostAction()
    {
        ...
        $hellourl = Mage::getUrl('zmb?step=3', array('_secure'=>true));
		if($this->getRequest()->getParam('page')){ echo 'hello'; die;
			$this->_redirectError(Mage::getUrl('*/*/create?page=zmb', array('_secure' => true)));
		}else{
    ...
    protected function _welcomeCustomer(Mage_Customer_Model_Customer $customer, $isJustConfirmed = false)
    {
		...
		$hellourl = Mage::getUrl('zmb?step=3', array('_secure'=>true));
		if($this->getRequest()->getParam('page') == 'zmb/'){
