 ...
 */
class Zimbrabilling_Zmb_Helper_Datanew extends Mage_Core_Helper_Abstract
{
    /**
    ...
    {   #echo 'hello'; die;
		...
		if($this->_getRequest()->getParam('page') == 'zmb'){
			return $this->_getUrl('customer/account/loginPost?page=zmb',$params);
		}
		else{
    ...
    {   if($this->_getRequest()->getParam('page') == 'zmb'){
		//if($this->_getRequest()->getParam('page')){
			return $this->_getUrl('customer/account/create?page=zmb');
		}else{
    ...
    {  
	  if($this->_getRequest()->getParam('page')){
			return $this->_getUrl('customer/account/createpost?page=zmb');
		}else{
